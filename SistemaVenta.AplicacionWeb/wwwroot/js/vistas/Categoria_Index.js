...
$(document).ready(function () {
    ...
    tablaData = $('#tbdata').DataTable({
        responsive: true,
        "ajax": {
            "url": '/CategoriaController1/Lista',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
$("#btnGuardar").on("click", function () {
    ...
    if (modelo.idCategoria == 0) {
        ...
        fetch("/CategoriaController1/Crear", {
            method: "POST",
        ...
        fetch("/CategoriaController1/Editar", {
            method: "PUT",
            headers: { "Content-Type": "application/json; charset=utf-8" },
            body: JSON.stringify(modelo)
        })
    ...
    swal({
        ...
        function (respuesta) {
            ...
            if (respuesta) {
                ...
                fetch(`/CategoriaController1/Eliminar?IdCategoria=${data.idCategoria}`, {
                    method: "DELETE"
                })
                    .then(response => {
