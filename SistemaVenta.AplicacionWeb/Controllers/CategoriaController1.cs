...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class CategoriaController1 : Controller
    {
        ...
        public CategoriaController1(IMapper mapper, ICategoriaService categoriaServicio)
        {
            _mapper = mapper;
        ...
        {
            List<VMCategoria> vmCtegoriaLista = _mapper.Map<List<VMCategoria>>(await _categoriaServicio.Lista());
            return StatusCode(StatusCodes.Status200OK, new { data = vmCtegoriaLista });
        }
